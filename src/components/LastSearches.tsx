				...
				{lastSearches.map((search) => (
					<li key={search} className="">
						<Link
							...
							className="flex bg-success border-2 border-transparent hover:border-2 hover:border-success bg-opacity-50 transition-colors px-2 w-fit items-center text-sm text-gray-800 max-w-full"
						>
